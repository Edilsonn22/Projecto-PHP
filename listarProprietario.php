...
$sql = "SELECT codigo_proprietario, nome, telefone, BI FROM proprietarios ORDER BY codigo_proprietario ASC";
      ...
      <section class="content-box">
        ...
        <table class="styled-table">
          ...
          <tbody>
            <?php if ($resultado->num_rows > 0): ?>
              <?php while ($proprietario = $resultado->fetch_assoc()): ?>
                <tr>
                  ...
                  <td>
                    <a href="editar_proprietario.php?id=<?= $proprietario['codigo_proprietario'] ?>" class="btn edit"><i
                        class="fa fa-pen"></i></a>
                    <a href="eliminar_proprietario.php?id=<?= $proprietario['codigo_proprietario'] ?>" class="btn delete"
                      onclick="return confirm('Deseja eliminar este proprietário?');"><i class="fa fa-trash"></i></a>
                  </td>
            ...
            <?php else: ?>
              <tr>
                <td colspan="5">Nenhum proprietário registado.</td>
              </tr>
            <?php endif; ?>
          </tbody>
        </table>
