...
$sql = "SELECT codigo_veiculo, matricula, marca, ano_fabrico, tipo FROM veiculos ORDER BY codigo_veiculo DESC";
...
<div class="container">
  ...
  <aside class="sidebar">
    ...
    <nav class="content">
      ...
      <a href="veiculos.php" class="active"><i class="fa fa-car"></i> Veículos</a>
          ...
          <?php if ($resultado->num_rows > 0): ?>
            <?php while ($veiculo = $resultado->fetch_assoc()): ?>
              <tr>
                ...
                <td><?= $veiculo['tipo'] ?></td>
                <td>
                  <a href="editar_veiculo.php?id=<?= $veiculo['codigo_veiculo'] ?>" class="btn edit"><i class="fa fa-pen"></i></a>
                  <a href="eliminar_veiculo.php?id=<?= $veiculo['codigo_veiculo'] ?>" class="btn delete" onclick="return confirm('Deseja eliminar este veículo?');"><i class="fa fa-trash"></i></a>
                </td>
              </tr>
            <?php endwhile; ?>
          <?php else: ?>
            <tr><td colspan="6">Nenhum veículo registado.</td></tr>
          <?php endif; ?>
        </tbody>
      </table>
    </section>
